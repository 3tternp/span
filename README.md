...
**[🌐 View Live Site](https://basnetprem.com.np)** &nbsp;·&nbsp; **[💼 LinkedIn](https://www.linkedin.com/in/prem-basnet524/)** &nbsp;·&nbsp; **[💻 GitHub](https://github.com/3tternp)**
...
A fully responsive, professional dark-themed portfolio website for **Prem Basnet** — built with React and showcasing 9+ years of cybersecurity expertise across information security auditing, GRC, offensive security, and cloud security.

| Domain | Details |
|---|---|
| **Current Role** | CSOC & SIEM Manager · Vairav Technology |
| **IS Auditing & GRC** | ISO 27001, SOC 2, PCI DSS, HIPAA, GDPR, NIST, COBIT |
| **Offensive Security** | VAPT, Penetration Testing, Red Teaming, API Security |
| **Cloud Security** | AWS & Azure security audits and configuration reviews |
| **Education** | M.Sc. IT (Running) · Islington College |
...
```
Home → Skills → Experience → Certifications → Work → Contact
```
...
```bash
git clone https://github.com/3tternp/span.git
cd span
```
...
|---|---|---|
| 1 | ISO 27001:2022 Lead Auditor | PECB / BSI |
| 2 | CRTP – Certified Red Team Professional | Altered Security |
| 3 | (ISC)² CC | (ISC)² |
| 4 | CNSS: Certified Network Security Specialist | ICSI, United Kingdom |
| 5 | AWS Security Fundamentals | Amazon Web Services |
...
| **Phone** | [+977-9861375054](tel:+9779861375054) |
| **LinkedIn** | [linkedin.com/in/prem-basnet524](https://www.linkedin.com/in/prem-basnet524/) |
| **GitHub** | [github.com/3tternp](https://github.com/3tternp) |
| **Live Site** | [basnetprem.com.np](https://basnetprem.com.np) |
